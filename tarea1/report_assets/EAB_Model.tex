...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{fig2_1.png}
\caption*{Figura 2.1: Consumo de agua vs. consumo eléctrico con la recta de regresión ajustada.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{fig5_1.png}
\caption*{Figura 5.1: $y^{(\lambda)}$ vs.\ $x$, con $\lambda=0$ y la recta de regresión ajustada.}
\end{figure}
